...
public:
    ...
    int GetServerConnectionState() const;
...
private:
    ...
    bool speaking_first_audio_ = true;     // Flag to detect first audio packet in Speaking state
    bool push_speaking_ = false;  // True when speaking from a server push (not a conversation)
    int clock_ticks_ = 0;
